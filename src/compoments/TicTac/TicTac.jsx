...
export const TicTac = () => {
    ...
    else if(data[0]===data[3] && data[3]===data[6] && data[5]!=="")
    {
      won (data[6]);
    }
  ...
  const reset = ()  => {
    setLock(false);
    data =["","","","","","","","",""];
    titleRef.current.innerHTML = 'Tic Tac In <span>React</span>'
  }
  return (
    <div className='container'>
      <h1 className='title'ref={titleRef}> Tic Tac Game In <span>React</span></h1>
      <div className='board'>
        <div className="row1">
